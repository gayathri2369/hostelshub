...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    _altEmailCtrl = TextEditingController();
  ...
  void _cancelEdit() {
    ...
    setState(() {
      ...
      _roomCtrl.text = user.roomNumber;
      _role = user.role;
      _isEditing = false;
    });
  }
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Manage your personal and hostel information',
                            style: TextStyle(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      user.role == UserRole.seller ? '🏪 Seller' : '🛍️ Buyer',
                      style: const TextStyle(
  ...
  // Profile Form (shared between web and mobile)
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          _SectionHeader(title: 'Hostel Information', icon: Icons.home_outlined),
          const SizedBox(height: 16),
            ...
            children: [
              Expanded(
                child: _FormField(
                  ...
                  enabled: true,
                  validator: (v) =>
                      (v == null || v.isEmpty) ? 'Hostel name required' : null,
                ),
              ),
              if (kIsWeb) ...[
                const SizedBox(width: 16),
                Expanded(
                  child: _FormField(
                    ...
                    enabled: true,
                    validator: (v) =>
                        (v == null || v.isEmpty) ? 'Room number required' : null,
                  ),
                ),
              ],
            ],
          ...
          // Account Details Section (view mode only)
          if (!_isEditing) ...[
            _SectionHeader(title: 'Account Details', icon: Icons.shield_outlined),
            const SizedBox(height: 16),
            ...
            child: Row(
              children: [
                ...
                TextButton(
                  ...
                  child: const Icon(Icons.arrow_forward_ios_rounded, size: 16, color: AppColors.error),
                ),
              ],
            ),
          ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        '"Every donation brings hope and builds a better tomorrow."',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 13,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(icon,
          color: enabled ? AppColors.primary : AppColors.textHint, size: 20),
        filled: true,
